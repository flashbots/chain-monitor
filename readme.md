...
OPTIONS:
   ...
   --l2-monitor-flashblocks-private-stream value [ --l2-monitor-flashblocks-private-stream value ]  private websocket stream(s) of l2 builder flashblocks [$CHAIN_MONITOR_L2_MONITOR_FLASHBLOCKS_PRIVATE_STREAMS]
   --l2-monitor-flashblocks-public-stream value                                                     public websocket stream of l2 builder flashblocks [$CHAIN_MONITOR_L2_MONITOR_FLASHBLOCKS_PUBLIC_STREAM]
